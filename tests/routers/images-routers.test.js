  ...
  describe(
    ...
    () => {
      describe('test with presetted data', () => {
        ...
        it('It should get relevant public images for page', (done) => {
          const page = 1;
          const limit = 2;
          ...
          chai
            ...
            .end((err, res) => {
              ...
              expect(reformatedBodyContent2).to.have.deep.eq(
                forCreateImage4 || forCreateImage2,
              );
              expect(reformatedBodyContent3).to.have.deep.eq(
                forCreateImage4 || forCreateImage2,
              );
              done();
            });
